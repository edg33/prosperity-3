...
class Trader:
    def run(self, state: TradingState):
        ...
        resin_window = 5  # Grid search optimized
        buy_threshold = -1.0  # Grid search optimized
        sell_threshold = 1.0  # Grid search optimized
        correlation_threshold = 0.2  # Grid search optimized
